...
ifdef ENABLE_ADVENTUREENGINE
DEFINES += -DENABLE_ADVENTUREENGINE=$(ENABLE_ADVENTUREENGINE)
MODULES += engines/AdventureEngine
endif

ifdef ENABLE_CATHARSIS
DEFINES += -DENABLE_CATHARSIS=$(ENABLE_CATHARSIS)
MODULES += engines/catharsis
endif
